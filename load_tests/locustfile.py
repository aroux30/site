...
class AnonymousCatalogBrowserUser(FastHttpUser):
...
class ActiveShopperUser(FastHttpUser):
...
class TransactionalCheckoutUser(FastHttpUser):
...
class StressHammerUser(FastHttpUser):
