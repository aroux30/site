...
class TaxRule(BaseModel):
    ...
    jurisdiction: Mapped[str] = mapped_column(String(50), default="IR", nullable=False)
    ...
    def __repr__(self) -> str:
        return f"<TaxRule(code='{self.code}', rate={self.rate_percent}%, category='{self.category.value}')>"  # noqa: E501
